      ...
      <header className="border-b backdrop-blur-sm bg-[rgb(var(--card))]/80 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-6 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl lime-tablet border-2 border-[rgb(var(--lime-bright))] flex items-center justify-center text-[rgb(var(--lime-medium))] text-xl shadow-lg animate-gentle-float">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            {exampleTopics.map((t) => (
              <button
                ...
                className="px-4 py-2 rounded-full bg-[rgb(var(--card))] border border-[rgb(var(--border))] text-sm text-[rgb(var(--muted-foreground))] hover:border-[rgb(var(--lime-medium))] hover:text-[rgb(var(--lime-medium))] transition-all hover:shadow-md"
              >
              ...
              {treeList.map((tree, index) => {
                ...
                return (
                  <button
                    ...
                    className="group bg-[rgb(var(--card))]/80 backdrop-blur-sm rounded-2xl border border-[rgb(var(--border))] p-6 text-left hover:shadow-xl hover:border-[rgb(var(--lime-medium))] transition-all duration-300 animate-fade-in"
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <h4
                            className="font-semibold text-lg text-[rgb(var(--foreground))] group-hover:text-[rgb(var(--lime-medium))] transition-colors"
                            style={{ fontFamily: "'Noto Serif', Georgia, serif" }}
                          >
                            {tree.topic}
                          </h4>
                          {isComplete && (
                            <span className="px-2 py-0.5 rounded-full bg-[rgb(var(--lime-medium-bg))] text-[rgb(var(--lime-medium))] text-xs font-medium border border-[rgb(var(--lime-medium))]">
                              Completed
                            </span>
                          )}
                        </div>
                      ...
                      <div className="text-right ml-4">
                        <div
                          className={`text-2xl font-bold ${isComplete ? 'text-[rgb(var(--lime-medium))]' : 'text-[rgb(var(--primary))]'}`}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-[rgb(var(--muted-foreground))] group-hover:text-[rgb(var(--lime-medium))] transition-colors">
                        View →
                      </span>
                    </div>
                  </button>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6 animate-fade-in" style={{ animationDelay: '400ms' }}>
          {[
            ...
            >
              <span
                className="text-3xl mb-3 block text-[rgb(var(--lime-medium))]"
                style={{ fontFamily: 'var(--font-brush-chinese)' }}
              >
                {f.icon}
              </span>
